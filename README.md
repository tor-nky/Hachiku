...
Autohotkey のバージョンによっては、新MS-IME(Win10 2004以降の標準)＋秀丸エディタ＋ノートパソコン内蔵キーボード の組み合わせで約1000文字に1回程度、英字に化けます。
...
* Windows 10 Home version 21H2 64-bit + AutoHotkey (v1.1.34.02 または v1.1.33.02) + 新旧MS-IME あるいは ATOK 2017
