...
; (2022年4月7日より)
; 【薙刀式】編集モードの移動選択部分
; http://oookaworks.seesaa.net/article/488459934.html#gsc.tab=0
; (2022年05月29日)より
; 【薙刀式】編集モード2右の現在
; http://oookaworks.seesaa.net/article/488695608.html#gsc.tab=0
; (2022年06月6日)より
;
; DvorakJ版からの変更部分：
...
kanaGroup := "2L"
	...
	SetKana( KC_M | KC_COMM | KC_Z	,"^x|{改行}^v《》{確定}{↑}{Space}+{↑}^x"	)	; ｜《》
	...
	SetEisu( KC_M | KC_COMM | KC_Z	,"^x|{改行}^v《》{改行}{↑}{Space}+{↑}^x"	)	; ｜《》
	...
	SetEisu( KC_M | KC_COMM | KC_B	,"　　　×　　　×　　　×{改行 2}"			)	; x   x   x
