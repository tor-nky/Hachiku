...
;
; 【薙刀式】v15の新候補あらわる
; http://oookaworks.seesaa.net/article/493628710.html#gsc.tab=0
; (2022年11月20日)より 配列
;
; DvorakJ版からの変更部分：
;	記号はすべて全角文字を出力する
...
kanaGroup := "2L"
	...
	SetEisu( KC_M | KC_COMM | KC_X	,"^x｜{確定}^v《》{確定}{↑}{C_Clr}"	)	; +｜《》
