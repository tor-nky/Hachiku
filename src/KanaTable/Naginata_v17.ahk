...
kanaGroup := "2R"
	...
	SetKana2(KC_C | KC_V | KC_L		,"+{← 7}"	,"+{← 7}"	, R)	; +←7
	SetKana( KC_C | KC_V | KC_DOT	,"{End}+{Home}"			)		; 一行選択
	SetKana( KC_C | KC_V | KC_P		,"^z"					)		; Undo
	SetKana2(KC_C | KC_V | KC_SCLN	,"+{→ 7}"	,"+{→ 7}"	, R)	; +→7
	SetKana( KC_C | KC_V | KC_SLSH	,"^y"					)		; Redo
	...
	SetEisu2(KC_C | KC_V | KC_L		,"+{← 7}"	,"+{← 7}"	, R)	; +←7
	SetEisu( KC_C | KC_V | KC_DOT	,"{End}+{Home}"			)		; 一行選択
	SetEisu( KC_C | KC_V | KC_P		,"^z"					)		; Undo
	SetEisu2(KC_C | KC_V | KC_SCLN	,"+{→ 7}"	,"+{→ 7}"	, R)	; +→7
	SetEisu( KC_C | KC_V | KC_SLSH	,"^y"					)		; Redo
